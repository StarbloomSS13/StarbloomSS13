...
/mob/living/simple_animal/bot/cleanbot
	...
	var/static/list/engineering = list("Chief Engineer" = "Grand Artificer", "Station Engineer" = "Engineer", "Atmospherics Technician" = "Technician")
	var/static/list/medical = list("Chief Medical Officer" = "Biolab Overseer", "Medical Doctor" = "M.D.", "Chemist" = "Pharm.D.")
