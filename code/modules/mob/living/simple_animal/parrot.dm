...
/mob/living/simple_animal/parrot/poly
	...
	speak = list("Poly wanna cracker!", ":e Check the reactor, you chucklefucks!",":e Wire the solars, you lazy bums!",":e WHO TOOK THE DAMN MODSUITS?",":e OH GOD ITS ABOUT TO MELT DOWN CALL THE SHUTTLE")
