...
/datum/round_event/portal_storm/syndicate_shocktroop
	boss_types = list(/mob/living/simple_animal/hostile/simple_human/syndicate/melee/space/stormtrooper = 2)
	hostile_types = list(/mob/living/simple_animal/hostile/simple_human/syndicate/melee/space = 8,\
						/mob/living/simple_animal/hostile/simple_human/syndicate/ranged/space = 2)
