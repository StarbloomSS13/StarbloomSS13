...
/datum/surgery_step/fix_eyes/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	...
	display_pain(target, "You feel a stabbing pain in your eyes!", target_zone = target_zone)
...
/datum/surgery_step/fix_eyes/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	display_pain(target, "Your vision blurs, but it seems like you can see a little better now!", target_zone = target_zone)
...
/datum/surgery_step/fix_eyes/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	if(target.getorgan(/obj/item/organ/brain))
		display_results(user, target, span_warning("You accidentally stab [target] right in the brain!"),
			...
			span_warning("[user] accidentally stabs [target] right in the brain!"))
		display_pain(target, "You feel a visceral stabbing pain right through your head, into your brain!", target_zone = target_zone)
		...
		display_results(user, target, span_warning("You accidentally stab [target] right in the brain! Or would have, if [target] had a brain."),
			...
			span_warning("[user] accidentally stabs [target] right in the brain!"))
		display_pain(target, "You feel a visceral stabbing pain right through your head!", target_zone = target_zone) // dunno who can feel pain w/o a brain but may as well be consistent.
	return FALSE
