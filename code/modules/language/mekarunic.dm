// Mekhane's language. It's a port of Rat'varian, to be a neat reference.
/datum/language/mekarunic
	name = "Mekarunic"
	desc = "A complex language designed by Mekhane to complement their ritualistic nature. Hard to speak in without implants." //No gameplay implementation yet
	secret = FALSE
	key = "r" //r for runic, m is used on moffic.
	default_priority = 10
	spans = list(SPAN_ROBOT)
	icon_state = "mekhane"

/datum/language/mekarunic/scramble(input)
