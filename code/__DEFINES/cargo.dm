...
GLOBAL_LIST_INIT(podstyles, list(\
	...
	list(POD_SHAPE_NORML, "darkpod",     TRUE, "syndicate", "red",      RUBBLE_NORMAL, "purple supply pod", "An intimidating supply pod, covered in the purple markings of the Syndicate. It's probably best to stand back from this."),\
