...
/proc/generate_titles()
	...
	if(!GLOB.end_credits_title)
		...
		possible_titles += "THE CREW LEARNS ABOUT [pick("LOVE", "DRUGS", "THE DANGERS OF MONEY LAUNDERING", "XENIC SENSITIVITY", "INVESTMENT FRAUD", "KELOTANE ABUSE", "RADIATION PROTECTION", "SACRED GEOMETRY", "STRING THEORY", "ABSTRACT MATHEMATICS", "[pick("UNATHI", "SKRELLIAN", "DIONAN", "KHAARMANI", "VOX", "SERPENTID")] MATING RITUALS", "THE IMPOSTER", "ANCIENT CHINESE MEDICINE")]"
		possible_titles += "A VERY [pick("CORPORATE", "FUNNY", "FLEET", "HEPHAESTUS", "DAIS", "XENOLIFE", "EXPEDITIONARY", "DIONA", "PHORON", "MARTIAN", "SERPENTID")] [pick("CHRISTMAS", "EASTER", "HOLIDAY", "WEEKEND", "THURSDAY", "VACATION")]"
		...
		possible_titles += "[pick("THE DAY [pick("THE UNITY", "THE LAST EDICT", "THE CULT OF THE HONKMOTHER")] STOOD STILL", "HUNT FOR THE GREEN WEENIE", "ALIEN VS VENDOMAT", "SPACE TRACK")]"
	...
	var/disclaimer = "<br>Sponsored by [pick("The Unity", "The Last Edict", "The Cult of the Honkmother")].<br>All rights reserved.<br>\
					This motion picture is protected under the copyright laws of the Unity.<br>"
	disclaimer += pick("Use for parody prohibited. PROHIBITED.",
						"All stunts were performed by underpaid interns. Do NOT try at home.",
						"The Unity does not endorse behaviour depicted. Attempt at your own risk.",
						"Any unauthorized exhibition, distribution, or copying of this film or any part thereof (including soundtrack)<br>\
						may result in the Royal Guards being called to storm your home and take it back by force.",
