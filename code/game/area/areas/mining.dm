...
/area/lushplanet
	name = "DO NOT USE /// BASETYPE ONLY"
	icon_state = "mining"
	has_gravity = STANDARD_GRAVITY
	flags_1 = NONE
	area_flags = VALID_TERRITORY | UNIQUE_AREA | FLORA_ALLOWED
	sound_environment = SOUND_AREA_LARGE_ENCLOSED
	ambient_buzz = 'sound/ambience/ambicave.ogg'

/area/lushplanet/play_ambience(mob/M, sound/override_sound, volume)
	if(prob(1))
		return ..(M, 'sound/ambience/Cave1.ogg') // Leaper Jumpscare
	return ..()

/area/lushplanet/surface
	name = "Lush Planetoid Surface"
	icon_state = "explored"
	always_unpowered = TRUE
	power_environ = FALSE
	power_equip = FALSE
...
/area/lushplanet/underground
	name = "Lush Planetoid Caves"
	icon_state = "unexplored"
	always_unpowered = TRUE
	requires_power = TRUE
	power_environ = FALSE
...
/area/lushplanet/surface/ruingen // Ruins + Mobs are allowed to spawn here, should either get implemented
	icon_state = "unexplored"
	area_flags = VALID_TERRITORY | UNIQUE_AREA | CAVES_ALLOWED | FLORA_ALLOWED | MOB_SPAWN_ALLOWED | NO_ALERTS
