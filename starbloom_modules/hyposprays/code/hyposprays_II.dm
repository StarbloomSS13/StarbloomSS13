...
/obj/item/hypospray/mkii
	...
	icon_state = "hypo2"
	icon = 'starbloom_modules/hyposprays/icons/hyposprays.dmi'
...
/obj/item/hypospray/mkii/update_overlays()
	...
	if(!small_only)
		...
		vial_spritetype += "-s"
	var/mutable_appearance/chem_loaded = mutable_appearance('starbloom_modules/hyposprays/icons/hyposprays.dmi', vial_spritetype)
...
/obj/item/hypospray/mkii/afterattack(atom/target, mob/living/user, proximity)
	...
	playsound(loc, long_sound ? 'starbloom_modules/hyposprays/sound/hypospray_long.ogg' : pick('starbloom_modules/hyposprays/sound/hypospray.ogg','starbloom_modules/hyposprays/sound/hypospray2.ogg'), 50, 1, -1)
