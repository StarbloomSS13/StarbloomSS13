/obj/item/reagent_containers/glass/vial
	...
	icon = 'starbloom_modules/hyposprays/icons/vials.dmi'
	icon_state = "hypovial"
	spillable = FALSE
	volume = 10
...
/obj/item/reagent_containers/glass/vial/update_overlays()
    ...
    if(reagents.total_volume)
        ...
        switch(round((reagents.total_volume / volume)*100))
            ...
            if(89 to 100)
                fill_overlay = 100
        var/mutable_appearance/filling = mutable_appearance('starbloom_modules/hyposprays/icons/hypospray_fillings.dmi', "[fill_name][fill_overlay]")
