...
/datum/opposing_force_equipment/martial_art/cqc
	...
	admin_note = "CQC is capable of knocking out a target in 3 hits and is equivalent to 23 TC. Chefs also \
	know this by default, so long as they're inside their kitchen."
...
/datum/opposing_force_equipment/martial_art/carp
	...
	admin_note = "Sleeping Carp allows the user to reflect projectile weaponry entirely."
...
/datum/opposing_force_equipment/martial_art/wrestling
	...
	admin_note = "Normally adminspawn only, powerful enough to be considered wizard kit."
